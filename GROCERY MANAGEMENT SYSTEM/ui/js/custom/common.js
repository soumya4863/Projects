...
var getReportApiUrl='http://127.0.0.1:5000/getReport';
var getyearReportApiUrl='http://127.0.0.1:5000/getyearReport';
...
function callApi(method, url, data) {
    $.ajax({
        ...
        url: url,
        data: data,
        error : function(e,ts,et){ alert('Insufficient Products');}
    }).done(function( msg ) {
        alert('Successful')
